...
var accItem = document.getElementsByClassName('skills__content');
var accHD = document.getElementsByClassName('skills__header');
...
function toggleItem() {
    ...
    for (i = 0; i < accItem.length; i++) {
        accItem[i].className = 'skills__content skills__close';
    }
...
/*==================== SCROLL SECTIONS qualification__active LINK ====================*/
